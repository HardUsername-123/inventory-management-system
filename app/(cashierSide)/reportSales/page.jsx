...
import { Search, Printer, Notebook, NotebookPenIcon } from "lucide-react";
...
const SalesReport = () => {
  ...
  const handlePrintPDF = () => {
    ...
    // Add logo (Replace 'logoBase64' with your actual Base64 string or image path)
    ...
    // Add table
    doc.autoTable({
      startY: 60, // Position table below title
      head: [
    ...
    <div className="p-5">
      <div className="overflow-x-auto h-[550px] w-full bg-myBgDark-lifgtDark rounded-lg px-3">
        ...
        <div className="flex justify-between">
          <div className="mb-6 mt-5 text-slate-200">
            <h3 className="text-xl font-semibold mb-2">Summary</h3>
            <p className="text-lg text-slate-200">Total Revenue {grandTotal}</p>
